...
export const AudienceStep = ({ data, updateData, onNext, onBack }: StepProps) => {
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-white/80 font-medium">
          ¿A quién está dirigido tu sitio web?
        </p>
      </div>

      <div className="space-y-6">
        <Label htmlFor="audience" className="text-white/90 text-lg font-semibold">
          Describí tu público objetivo (edad, intereses, necesidades)
        </Label>
        <Textarea
          id="audience"
          placeholder="Ej: Emprendedores entre 25-40 años que buscan servicios de diseño profesional para mejorar su presencia online..."
        ...
        <p className="text-sm text-white/70">
          Sé específico sobre quiénes son tus usuarios ideales
        </p>
      </div>
