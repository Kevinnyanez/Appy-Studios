...
export const VisualStyleStep = ({ data, updateData, onNext, onBack }: StepProps) => {
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-white/80 font-medium">
          ¿Cómo te imaginás el diseño de tu sitio?
        </p>
      </div>

      <div className="space-y-6">
        <Label htmlFor="visualStyle" className="text-white/90 text-lg font-semibold">
          Describí colores, sensaciones, referencias o estilos que te gusten
        </Label>
        <Textarea
          id="visualStyle"
          placeholder="Ej: Minimalista con colores azules y blancos, tipografía moderna, sensación profesional y confiable..."
        ...
        <p className="text-sm text-white/70">
          Incluí referencias de marcas o sitios que te inspiren
        </p>
      </div>
